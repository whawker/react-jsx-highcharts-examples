...
class InvertedChart extends Component {
    ...
    return (
      <div className="app">
        <HighchartsChart plotOptions={plotOptions}>
          ...
          <YAxis id="average" min={2.4} max={7} gridLineWidth={0} labels={{ enabled: false }}>
...
export default withHighcharts(InvertedChart, Highcharts);
